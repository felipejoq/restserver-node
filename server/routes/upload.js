...
//Middleware para que los archivos puedan ser obtenidos desde la propiedad u objeto req.files
app.use(fileUpload());
...
app.put('/upload/:tipo/:id', (req, res) => {
    ...
    if (tiposValidos.indexOf(tipo) < 0) {
        return res.status(400).json({
            ok: false,
            err: {
                message: 'Los tipos válidos son los siguientes: ' + tiposValidos.join(', '),
            }
        });
    }
